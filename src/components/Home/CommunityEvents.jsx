    ...
    <section className="py-16 bg-gradient-to-br from-base-100 to-base-200">
      <div className="container mx-auto px-2 md:px-4">
        ...
        <div className="flex flex-col lg:flex-row gap-6">
          {/* Events Calendar */}
          <div className="lg:w-2/3 bg-base-100 rounded-xl  overflow-hidden border border-base-300">
            <div className="bg-primary text-primary-content p-4 flex items-center gap-6">
            ...
            <div className="divide-y divide-base-300">
              {upcomingEvents.map((event, index) => (
                <div
                  key={index}
                  className="p-6 hover:bg-base-200/50 transition-colors duration-200"
                >
          ...
          <div className="lg:w-1/3 space-y-6">
            <div className="bg-base-100 p-6 rounded-xl  border border-base-300">
              ...
              <p className="text-base-content/80 mb-4">
                Access our exclusive resident portal to connect with neighbors,
                join committees, and participate in community decisions.
              </p>
              <Button
                className="btn-sm"
                onClick={handleClick}
        ...
        <div className="mt-12 text-center">
          ...
          <p className="text-base-content/80 mb-6 max-w-2xl mx-auto">
            Our community spaces are available for resident-organized
